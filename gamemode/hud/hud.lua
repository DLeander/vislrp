...
function HUD()
    ...
    -- HUD Background
    draw.RoundedBox(0, 0, ScrH()-45, ScrW(), ScrH(), Color(18,18,18, 155)) -- ( number cornerRadius, number x, number y, number width, number height, table color )
    draw.RoundedBox(0, 0, 0, ScrW(), 45, Color(18,18,18, 155)) -- ( number cornerRadius, number x, number y, number width, number height, table color )
    ...
    -- draw.RoundedBox(1, ScrW() - 1665, ScrH() - hungerheight, client:GetNWInt("visl_hunger"), 15, Color(0,190,75,255))
    -- draw.SimpleText("Hunger: " .. math.Round(client:GetNWInt("visl_hunger"), 0), "DermaDefaultBold", ScrW() - 1645, ScrH() - hungerheight, Color(255,255,255), 0, 0)
...
function GM:HUDDrawTargetID()
    ...
    if (distance < 125) then
        ...
        draw.SimpleText( text, font, x + 1, y + 1, Color( 0, 0, 0, 120 ),1 )
        draw.SimpleText( text, font, x + 2, y + 2, Color( 0, 0, 0, 50 ),1 )
        draw.SimpleText( text, font, x, y, Color(255,255,255,255),1)
        ...
        draw.SimpleText( trace.Entity:GetNWString("charDesc"), font, x + 1, y + 1, Color( 0, 0, 0, 120 ),1 )
        draw.SimpleText( trace.Entity:GetNWString("charDesc"), font, x + 2, y + 2, Color( 0, 0, 0, 50 ),1 )
        draw.SimpleText( trace.Entity:GetNWString("charDesc"), font, x, y, Color(255,255,255,255),1 ) 
        ...
        draw.SimpleText( pointedClass.name, font, x + 1, y + 1, Color( 0, 0, 0, 120 ),1 )
        draw.SimpleText( pointedClass.name, font, x + 2, y + 2, Color( 0, 0, 0, 50 ),1 )
        draw.SimpleText( pointedClass.name, font, x, y, Color(pointedClass.color[1],pointedClass.color[2],pointedClass.color[3],255),1) 
        ...
        if trace.Entity:Health() <= 100 and trace.Entity:Health() >= 80 then
            ...
            draw.SimpleText( "Very Healthy", font, x + 1, y + 1, Color( 0, 0, 0, 120 ), 1 )
            draw.SimpleText( "Very Healthy", font, x + 2, y + 2, Color( 0, 0, 0, 50 ), 1 )
            draw.SimpleText( "Very Healthy", font, x, y, Color(0,255,0,255), 1) 
        elseif trace.Entity:Health() < 80 and trace.Entity:Health() >= 50 then
            ...
            draw.SimpleText( "Healthy", font, x + 1, y + 1, Color( 0, 0, 0, 120 ),1 )
            draw.SimpleText( "Healthy", font, x + 2, y + 2, Color( 0, 0, 0, 50 ),1 )
        ...
        elseif trace.Entity:Health() < 50 and trace.Entity:Health() >= 30 then
            ...
            draw.SimpleText( "Fine", font, x + 1, y + 1, Color( 0, 0, 0, 120 ),1 )
            draw.SimpleText( "Fine", font, x + 2, y + 2, Color( 0, 0, 0, 50 ),1 )
            ...
            draw.SimpleText( "Injured", font, x + 1, y + 1, Color( 0, 0, 0, 120 ),1 )
            draw.SimpleText( "Injured", font, x + 2, y + 2, Color( 0, 0, 0, 50 ),1 )
...
hook.Add("HUDShouldDraw", "VC_HUD_Disable_Name_visl", function(name)
	if name == "VCMod_Side" or name == "VCMod_Entity" then return false end
end)
